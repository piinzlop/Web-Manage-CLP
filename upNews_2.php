...
while ($row = mysqli_fetch_array($sql)) {
  ...
  $news2_id = $_GET['id'];
  $updateuser = new DB_con();
  $sql = $updateuser->fetchonerecord2($news2_id);
  while ($row = mysqli_fetch_array($sql)) {
        ...
        <section class="section dashboard">
          <div class="card">
            <div class="card-body">
              ...
              $query = "SELECT * FROM news_2 LIMIT $start, $records_per_page";
              $result = mysqli_query($conn, $query);

              // Calculate the total number of pages
              $query = "SELECT COUNT(*) as num_records FROM news_2";
              $result = mysqli_query($conn, $query);
              ...
              for ($i = 1; $i <= $num_pages; $i++) {
                ...
                <ul class="pagination justify-content-center">
                  <li class="page-item"><a class="page-link" href="upNews_2.php?id=' . $i . '">' . $i . '</a></li>
                </ul>
