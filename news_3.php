...
if (isset($_POST['insert3'])) {
  ...
  $sql = $conn->insert3($newsName3, $img3, $img32, $img33, $img34, $img35, $img36, $NewsMsg3, $note3, $modi_user3);
  ...
  if ($sql) {
    ...
    echo "<script>window.location.href='news_3.php'</script>";
  }
}
  ...
  <body>
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            ...
            <li>
              <a href="news_3.php" class="active">
    ...
    <main id="main" class="main">
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">เพิ่มข่าว 3</li>
          </ol>
        </nav>
      </div><!-- End Page Title -->
      ...
      <section class="section dashboard">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">เพิ่มข่าวเพจ 3</h5>
            ...
            <form class="row g-3" action="" method="post">
              ...
              <div class="col-md-12">
                <div class="form-floating">
                  <input type="text" class="form-control" name="newsName3" placeholder="newsName3" require>
                  <label for="newsName3">ชื่อหัวข่าว</label>
                </div>
              </div>
              ...
              <div id="img-fields">
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" name="img3" placeholder="img3" require>
                    <label for="img3">ลิ้งค์รูป 3</label>
                  </div>
                </div>
              </div>
                    ...
                    newField.innerHTML =
                      ...
                      <div class="col-md-12">
                        <div class="form-floating">
                          ...
                          <label for="img3${imgFieldCount}">ลิ้งค์รูปเพิ่มเติม </label>
                        </div>
                      </div>
                      `;
              ...
              <div class="col-12">
                <div class="form-floating">
                  <textarea class="form-control" placeholder="NewsMsg3" name="NewsMsg3" style="height: 100px;" require></textarea>
                  <label for="NewsMsg3">เนื้อหาข่าว</label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" name="note3" placeholder="note3" require>
                    <label for="note3">หมายเหตุ</label>
                  </div>
                </div>
              </div>
              <div clase="col-md-12">
              ...
              <div class="text-center">
                <button type="submit" name="insert3" class="btn btn-primary">ยืนยัน</button>
                <a href="upNews_3.php?id=1" class="btn btn-success">แก้ไข</a>
