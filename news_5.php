...
if (isset($_POST['insert5'])) {
  ...
  if ($sql) {
    ...
    echo "<script>window.location.href='news_5.php'</script>";
  }
}
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="news_5.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">เพิ่มข่าว 5</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
            ...
            <form class="row g-3" action="" method="post">
              ...
              <div class="col-md-12">
                <div class="form-floating">
                  <input type="text" class="form-control" name="newsName5" placeholder="newsName5" require>
              ...
              <div class="col-md-12">
                <div class="form-floating">
                  ...
                  <label for="img5">ไฟล์รูป</label>
                </div>
              </div>
              <div class="col-12">
                <div class="form-floating">
                  <textarea class="form-control" placeholder="NewsMsg5" name="NewsMsg5" style="height: 100px;" require></textarea>
                  <label for="NewsMsg5">เนื้อหาข่าว</label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" name="note5" placeholder="note5" require>
                    <label for="note5">หมายเหตุ</label>
                  </div>
                </div>
              </div>
