...
if (isset($_POST['insert2'])) {
  ...
  $sql = $conn->insert2($newsName2, $img2, $img22, $img23, $img24, $img25, $img26, $NewsMsg2, $note2, $modi_user2);
  ...
  if ($sql) {
    ...
    echo "<script>window.location.href='news_2.php'</script>";
  }
}
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            ...
            <li>
              <a href="news_2.php" class="active">
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">เพิ่มข่าว 2</li>
          </ol>
        </nav>
      </div><!-- End Page Title -->
          ...
          <div class="card-body">
            ...
            <form class="row g-3" action="" method="post">
              ...
              <div class="text-center">
                <button type="submit" name="insert2" class="btn btn-primary">ยืนยัน</button>
                <a href="upNews_2.php?id=1" class="btn btn-success">แก้ไข</a>
