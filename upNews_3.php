...
if (isset($_POST['update3'])) {
  ...
  $img32 = htmlentities(empty($_POST['img32'])) ? "" : $_POST['img32'];
  $img33 = htmlentities(empty($_POST['img33'])) ? "" : $_POST['img33'];
  $img34 = htmlentities(empty($_POST['img34'])) ? "" : $_POST['img34'];
  $img35 = htmlentities(empty($_POST['img35'])) ? "" : $_POST['img35'];
  $img36 = htmlentities(empty($_POST['img36'])) ? "" : $_POST['img36'];
  $NewsMsg3 = htmlentities($_POST['NewsMsg3']);
  $note3 = htmlentities($_POST['note3']);
  $modi_user3 = htmlentities($_POST['modi_user3']);

  $sql = $conn->update3($newsName3, $img3, $img32, $img33, $img34, $img35, $img36, $NewsMsg3, $note3, $modi_user3, $news3_id);
  if ($sql) {
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body>
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            ...
            <li>
              <a href="upNews_3.php?id=1" class="active">
      ...
      <div class="pagetitle">
        ...
        <nav>
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">แก้ไขข่าว 3</li>
          </ol>
        </nav>
      </div><!-- End Page Title -->
            ...
            <form class="row g-3" action="" method="post">
              <div class="col-md-12">
                <div class="form-floating">
                  <p>ชื่อข่าว : </p>
                  <!-- <label for="newsName3"></label> -->
                  <input type="text" class="form-control" name="newsName3" placeholder="newsName3" value="<?php echo $row['newsName3']; ?>" require>
                </div>
              </div>
              ...
              <?php if (!empty($row['img32'])) : ?>
                <div class="col-md-12">
                  <div class="form-floating">
                    <p>ลิ้งค์รูปที่ 2 : <button class="btn btn-outline-primary" onclick="popUpImage('<?php echo $row['img32'] ?>')">ตัวอย่างภาพ</button></p>
                    <input type="text" id="image_url" class="form-control" name="img32" value="<?php echo $row['img32']; ?>">
                  </div>
                </div>
              <?php else : ?>
                <div id="inputContainer" style="display: none;">
                  <p>ลิ้งค์รูปที่ 2 : </p>
                  <div class="form-floating">
                    <input type="text" id="image_url" class="form-control" name="img32">
                  </div>
                </div>
              <?php endif; ?>

              <?php if (!empty($row['img33'])) : ?>
                <div class="col-md-12">
                  <div class="form-floating">
                    <p>ลิ้งค์รูปที่ 3 : <button class="btn btn-outline-primary" onclick="popUpImage('<?php echo $row['img33'] ?>')">ตัวอย่างภาพ</button></p>
                    <input type="text" id="image_url" class="form-control" name="img33" value="<?php echo $row['img33']; ?>">
                  </div>
                </div>
              <?php else : ?>
                <div id="inputContainer" style="display: none;">
                  <p>ลิ้งค์รูปที่ 3 : </p>
                  <div class="form-floating">
                    <input type="text" id="image_url" class="form-control" name="img33">
                  </div>
                </div>
              <?php endif; ?>

              <?php if (!empty($row['img34'])) : ?>
                <div class="col-md-12">
                  <div class="form-floating">
                    <p>ลิ้งค์รูปที่ 4 : <button class="btn btn-outline-primary" onclick="popUpImage('<?php echo $row['img34'] ?>')">ตัวอย่างภาพ</button></p>
                    <input type="text" id="image_url" class="form-control" name="img34" value="<?php echo $row['img34']; ?>">
                  </div>
                </div>
              <?php else : ?>
                <div id="inputContainer" style="display: none;">
                  <p>ลิ้งค์รูปที่ 4 : </p>
                  <div class="form-floating">
                    <input type="text" id="image_url" class="form-control" name="img34">
                  </div>
                </div>
              <?php endif; ?>

              <?php if (!empty($row['img35'])) : ?>
                <div class="col-md-12">
                  <div class="form-floating">
                    <p>ลิ้งค์รูปที่ 5 : <button class="btn btn-outline-primary" onclick="popUpImage('<?php echo $row['img35'] ?>')">ตัวอย่างภาพ</button></p>
                    <input type="text" id="image_url" class="form-control" name="img35" value="<?php echo $row['img35']; ?>">
                  </div>
                </div>
              <?php else : ?>
                <div id="inputContainer" style="display: none;">
                  <p>ลิ้งค์รูปที่ 5 : </p>
                  <div class="form-floating">
                    <input type="text" id="image_url" class="form-control" name="img35">
                  </div>
                </div>
              <?php endif; ?>

              <?php if (!empty($row['img36'])) : ?>
                <div class="col-md-12">
                  <div class="form-floating">
                    <p>ลิ้งค์รูปที่ 6 : <button class="btn btn-outline-primary" onclick="popUpImage('<?php echo $row['img36'] ?>')">ตัวอย่างภาพ</button></p>
                    <input type="text" id="image_url" class="form-control" name="img36" value="<?php echo $row['img36']; ?>">
                  </div>
                </div>
              <?php else : ?>
                <div id="inputContainer" style="display: none;">
                  <p>ลิ้งค์รูปที่ 6 : </p>
                  <div class="form-floating">
                    <input type="text" id="image_url" class="form-control" name="img36">
                  </div>
                </div>
              ...
              <div class="col-12">
                <div class="form-floating">
                  <p>เนื้อหาข่าว : </p>
                  <!-- <label for="NewsMsg3"></label> -->
                  <textarea class="form-control" placeholder="NewsMsg3" name="NewsMsg3" style="height: 150px;" require><?php echo $row['NewsMsg3']; ?></textarea>
                </div>
              </div>
              <div class="col-md-12">
                <div class="col-md-12">
                  <div class="form-floating">
                    ...
                    <input type="text" class="form-control" name="note3" placeholder="note3" value="<?php echo $row['note3']; ?>">
                  </div>
                </div>
              </div>
              <div class="col-md-12">
              ...
              <div class="text-center">
                <button type="submit" name="update3" class="btn btn-primary">ยืนยัน</button>
    ...
    <ul class="pagination justify-content-center">
      <li class="page-item"><a class="page-link" href="upNews_3.php?id=' . $row['news3_id'] . '">' . $row['news3_id'] . '</a></li>
    </ul>
